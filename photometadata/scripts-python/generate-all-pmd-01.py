...
jsonOutputFp = "IPTC-PhMdStd-All_byPyAutogen2.json"
...
def generate_IPTCPMD_etJSON():
    ...
    if valstr != '':
        valobj1['City'] = valstr
    valstr = 'Country ISO-Code value'
    if valstr != '':
        valobj1['CountryCode'] = valstr
    valstr = 'Country Name value'
    if valstr != '':
        valobj1['CountryName'] = valstr
    valstr = 'Location Identifier value'
    if valstr != '':
        valobj1['LocationId'] = valstr
    valstr = 'Location Name value'
    if valstr != '':
        valobj1['LocationName'] = valstr
    valstr = 'Province or State value'
    if valstr != '':
        valobj1['ProvinceState'] = valstr
    valstr = 'Sublocation value'
    if valstr != '':
        valobj1['Sublocation'] = valstr
    valstr = 'World Region value'
    if valstr != '':
