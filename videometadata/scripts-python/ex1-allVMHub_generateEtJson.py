...
# -*- coding: utf-8 -*-
"""
    This script generates all video metadata properties
       defined by the IPTC Video Metadata Hub Recommendation 1.2
    For this purpose a JSON document is generated - as file - which can be processed by the exiftool.

    The values of the properties are set by the content of the ex1-allVMHub_propValues.yml YAML file.
...
jsonOutputFp = "ex1-allVMHub_etData.json"

def generate_IPTCVMD_etJSON():
    print("START")
    ivmdpropvalYamlfile = open('ex1-allVMHub_propValues.yml', 'r', encoding="utf-8")
