<#
    Video Metadata Hub - Script to create a JSON file for Exiftool with all 
    IPTC Video Metadata Hub Recommendation 1.2 properties populated
#>

# ********** Intro ********************************************************
# ***** Parameters
# $inputFp = "" # input file path
$jsonOutputFp = "ex1-allVMHub_etData.json" # JSON output file path
